...
exports.flatArray = exports.isContextProvider = exports.isElement = exports.isKey = exports.hasKey = exports.getParentDom = exports.insertAfter = exports.updateWorkInProgressHook = exports.findPrevSiblingFiber = exports.isEmpty = void 0;
// 判断是否为空值
...
function isContextProvider(ele) {
    ...
    return kindOf(t) === 'symbol' &&
        Symbol.keyFor(t) === 'lzyContextElement';
}
